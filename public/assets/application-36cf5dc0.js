...
var snack_base_controller_default = class extends Controller {
  ...
  hideBase() {
    if (!this.hasBaseTarget) return;
    this.baseTarget.classList.add("opacity-0");
    if (!this.hasMenuTarget) return;
    this.MenuTarget.classList.add("opacity-0");
  }
  showBase() {
    if (!this.hasBaseTarget) return;
    this.baseTarget.classList.remove("opacity-0");
    if (!this.hasMenuTarget) return;
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-c6a2cc6a.js.map

...
var bgm_controller_default = class extends Controller {
  static targets = ["audio", "button", "volume", "panel"];
  connect() {
    this.enabled = localStorage.getItem("bgm") === "on";
    const savedVolume = localStorage.getItem("bgmVolume");
    if (savedVolume) {
      this.audioTarget.volume = parseFloat(savedVolume);
      this.volumeTarget.value = savedVolume;
    } else {
      this.audioTarget.volume = 0.35;
      this.volumeTarget.value = 0.35;
    }
    this.updateButton();
    if (this.enabled) {
      this.play();
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-c74cb60a.js.map

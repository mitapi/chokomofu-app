...
var character_expression_controller_default = class extends Controller {
  ...
  connect() {
    this.update("face_idle");
  }
  change(event) {
    const expressionKey = event.detail.expressionKey || "face_idle";
    this.update(expressionKey);
  }
  update(expressionKey) {
    const src = this.expressionsValue[expressionKey] || this.expressionsValue["face_idle"];
    if (!src) return;
...
application.register("character_expression", character_expression_controller_default);
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-21c6899d.js.map

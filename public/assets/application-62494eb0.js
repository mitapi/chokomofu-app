...
var character_expression_controller_default = class extends Controller {
  ...
  connect() {
    console.log("character-expression connected");
    console.log("expressionsValue:", this.expressionsValue);
  }
  change(event) {
    console.log("character-expression#change called");
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-f6c311e9.js.map

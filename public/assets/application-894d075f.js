...
// app/javascript/controllers/conversation_step_controller.js
var conversation_step_controller_default = class extends Controller {
...
// app/javascript/controllers/bubble_fade_controller.js
var bubble_fade_controller_default = class extends Controller {
  connect() {
    requestAnimationFrame(() => {
...
// app/javascript/controllers/welcome_steps_controller.js
var welcome_steps_controller_default = class extends Controller {
...
// app/javascript/controllers/snack_reaction_controller.js
var snack_reaction_controller_default = class extends Controller {
  ...
  startMain() {
    ...
    this._timeoutId = window.setTimeout(() => {
      ...
      const currentLine = document.querySelector('[data-conversation-step-target="line"]:not(.hidden)');
...
// app/javascript/controllers/snack_base_controller.js
var snack_base_controller_default = class extends Controller {
...
// app/javascript/controllers/snack_loading_controller.js
var snack_loading_controller_default = class extends Controller {
  static targets = ["text"];
  connect() {
...
// app/javascript/controllers/diary_modal_controller.js
var diary_modal_controller_default = class extends Controller {
  close(event) {
...
// app/javascript/controllers/character_expression_controller.js
var character_expression_controller_default = class extends Controller {
...
var bgm_controller_default = class extends Controller {
  static targets = ["audio", "slider"];
  connect() {
    const bgmSetting = localStorage.getItem("bgm");
    const savedVolume = localStorage.getItem("bgmVolume");
    if (this.hasSliderTarget) {
      this.sliderTarget.value = savedVolume ?? "0.1";
    }
    this.audioTarget.volume = Number(savedVolume ?? 0.1);
    const shouldPlay = bgmSetting !== "off";
    if (shouldPlay) {
      this.playIfPaused();
    } else {
  ...
  changeVolume() {
    const volume = Number(this.sliderTarget.value);
    this.audioTarget.volume = volume;
    localStorage.setItem("bgmVolume", String(volume));
  }
  playIfPaused() {
    if (this.audioTarget.paused) {
      this.audioTarget.play().catch((error2) => {
        console.error("BGM\u306E\u518D\u751F\u306B\u5931\u6557\u3057\u307E\u3057\u305F", error2);
      });
    }
  }
};
...
application.register("conversation-step", conversation_step_controller_default);
application.register("bubble-fade", bubble_fade_controller_default);
application.register("welcome-steps", welcome_steps_controller_default);
application.register("snack-reaction", snack_reaction_controller_default);
application.register("snack-base", snack_base_controller_default);
application.register("snack-loading", snack_loading_controller_default);
application.register("diary-modal", diary_modal_controller_default);
application.register("character-expression", character_expression_controller_default);
application.register("bgm", bgm_controller_default);
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-40e119a6.js.map

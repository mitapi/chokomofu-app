...
var conversation_step_controller_default = class extends Controller {
  ...
  emitStepChange() {
    this.element.dispatchEvent(
      new CustomEvent("step:change", { bubbles: true, detail: { expressionKey } })
    );
  }
};
...
var snack_reaction_controller_default = class extends Controller {
  ...
  connect() {
    ...
    document.addEventListener("step:change", this._onStepChange);
  ...
  startMain() {
    ...
    this._timeoutId = window.setTimeout(() => {
      ...
      this.updateExpressionByKey("face_idle");
  ...
  updateExpressionByKey(key) {
    ...
    const url = map[key];
    console.log("[snack-reaction] updateExpressionByKey", key, "=>", url);
    if (url && this.frame3Target) this.frame3Target.src = url;
  }
  close(event) {
    event?.preventDefault();
    event?.stopPropagation();
  ...
  disconnect() {
    ...
    if (this._onStepChange) document.removeEventListener("step:change", this._onStepChange);
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-58c9561e.js.map

...
ActiveRecord::Schema[7.1].define(version: 2026_04_17_141807) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.index ["code"], name: "index_conversations_on_code", unique: true
  end
  ...
  create_table "mofu_diaries", force: :cascade do |t|
    ...
    t.index ["share_token"], name: "index_mofu_diaries_on_share_token", unique: true
